...
<body>
    <div class="container">
        ...
        <div class="menu-grid" style="display:grid;grid-template-columns:repeat(4,1fr);gap:16px;">
            ...
            <a href="/error.php" class="menu-item" style="display:block;padding:20px;background:#e8eaf6;border-radius:8px;text-decoration:none;color:#1a237e;text-align:center;">
                <span style="font-size:32px;display:block;">📋</span>
                <strong>Debug</strong>
            </a>
        </div>
