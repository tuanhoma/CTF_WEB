...
<head>
    ...
    <style>
        ...
        .message-box { background:#fff8f8; border-left:4px solid #b71c1c; padding:16px; border-radius:0 8px 8px 0; min-height:60px; }
        .back-btn { background:#b71c1c; color:white; padding:8px 16px; border-radius:4px; text-decoration:none; }
    </style>
</head>
<body>
<div class="container">
